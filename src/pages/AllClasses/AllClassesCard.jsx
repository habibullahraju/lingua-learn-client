...
const AllClassesCard = ({allClass}) => {
  ...
  const handleSelectItem = (item) => {
    ...
    if (user && user.email) {
      ...
      fetch("https://lingualearn-server.vercel.app/carts", {
        method: "POST",
        headers: {
  ...
  return (
    <div
      className={`card w-full  shadow-xl ${
        availableSeat !== 0 ? "bg-base-100" : "bg-red-500"
      }`}
    >
      <figure>
      ...
      <div className="card-body">
        ...
        <p>
          <span className="font-bold">Available Seats:</span> {availableSeat}
        </p>
        <p>
        ...
        <div className="card-actions justify-end">
          <button
            onClick={() => handleSelectItem(allClass)}
